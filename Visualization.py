...
def plotMeetingGraphs(robots, index, subplot=None):
    if subplot != None:
        plt.subplot(2,2,subplot)
#    plt.figure('Graphs for robots %.d and %.d' %(index[0],index[1]))
...
def plotMeetingPaths(robots, index, subplot=None):
    if subplot != None:
        plt.subplot(2,2,subplot)
#    plt.figure('Paths for robots %.d and %.d' %(index[0],index[1]))
